...
#steward-review-root button { appearance: none; display: inline-flex; flex: 0 0 auto; align-items: center; justify-content: center; width: auto; min-width: 0; max-width: none; height: 38px; cursor: pointer; margin: 0; border: 0; border-radius: 999px; padding: 0 13px; color: #e2e8f0; background: transparent; transition: background .14s ease, color .14s ease, box-shadow .14s ease, transform .14s ease; font: 650 13px/1 inherit; text-transform: none; letter-spacing: normal; white-space: nowrap; }
...
.steward-review-popup button { appearance: none; width: auto; min-width: 0; max-width: none; height: auto; cursor: pointer; margin: 0; border: 0; border-radius: 8px; padding: 7px 10px; font: 700 12px/1 inherit; text-transform: none; letter-spacing: normal; white-space: nowrap; }
